...
Grad-CAM visualiza las regiones de la imagen que más contribuyen a la decisión del modelo mediante el cálculo de gradientes de la clase objetivo respecto a los mapas de activación de la última capa convolucional. Los resultados muestran diferencias claras entre ambos modelos (Figura \ref{fig:gradcam}).
