...
Grad-CAM visualiza las regiones de una imagen concreta que más contribuyen a la decisión del modelo mediante el cálculo de gradientes de la clase objetivo respecto a los mapas de activación de la última capa convolucional. De esta forma, se generan mapas de calor superpuestos a la imagen original que indican las áreas de mayor atención del modelo.
